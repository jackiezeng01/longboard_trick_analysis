...
load(filename,'Acceleration','Orientation','AngularVelocity', 'Position')
...
t_Position=CreateTimeVector(Position.Properties.RowTimes);
...
Positi_rate=1/mean(diff(t_Position));
...
MotionData.Position=table2array(timetable2table(Position,'ConvertRowTimes',false));
